...
const AddClientPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSuccess("");
    try {
      // Use the password entered by admin
      if (!password) {
      ...
      setSuccess(`Client added successfully! Welcome email sent to ${email}`);
      setName("");
      setEmail("");
      setBusiness("");
      setPassword("");
  ...
  return (
    <>
      ...
      <div className="p-4 sm:p-8 max-w-xl mx-auto">
        <h1 className="text-xl font-bold mb-4 text-black">Add New Client</h1>
        <form onSubmit={handleSubmit} className="bg-white p-4 sm:p-6 rounded shadow">
